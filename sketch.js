...
function setup() {
  ...
  player = new Player(285, playerBase.body.position.y - 153, 100, 200);
  ...
  computerArcher = new ComputerArcher(
    600,
    computerBase.body.position.y - 160,
    120,
    120
  );
...
function handlePlayerArrowCollision() {
  ...
  for (var i = 0; i < playerArrows.length; i++) {
    ...
    //computerArcherLife -= 2;
    //computerArcherLife -= 3;
  ...
  swal(
    {
      ...
      imageUrl:
      "https://raw.githubusercontent.com/whitehatjr/EpicArchery/main/assets/player.png",
      imageSize:"150x150",
